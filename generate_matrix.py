...
if __name__ == '__main__':
    text1, text2 = generate_term_document_meeting(option='text', tf_idf_threshold=[9000, 6000])
    #plot_word_cloud(text1, filename='WordCloud_FOMC1.eps')
    #plot_word_cloud(text2, filename='WordCloud_FOMC2.eps')
